...
declare module 'shaka-player' {
  ...
  interface EventMap {
    ...
    'mediaqualitychanged': Player.MediaQualityChangedEvent,
  }
  ...
  namespace Player {
     ...
     */
    interface LargeGapEvent extends Event {
      type: 'largegap';
    ...
    /**
     * Fired when player jumps a gap in the media timeline.
     */
    interface GapJumpEvent extends Event {
      type: 'gapjump';
      /** The current time of the playhead. */
      currentTime: number;
    ...
    interface MediaQualityChangedEvent extends Event {
      type: 'mediaqualitychanged';
      mediaQuality: extern.MediaQualityInfo;
      position: number,
    }
  }
  ...
  namespace util {
    ...
    class AbortableOperation<T, A = any> implements extern.IAbortableOperation<T> {
      promise: Promise<T>;
