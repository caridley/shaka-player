...
/**
 * @event shaka.Player.GapJumpEvent
 * @description Fired when the player jumps a gap in the media teimline.
 * @property {string} type
 *   'gapjump'
 * @property {number} currentTime
 *   The current time of the playhead.
 * @property {number} preJump
 *   Amount of time prior to gap at which jump is initiated
 * @property {number} overJump
 *   Jumped this amount of content after the gap
 * @property {number} gapStart
 *   The start of the gap
 * @property {number} gapEnd
 *   The end of the gap
 * @property {number} gapSize
 *   Size of the gap in seconds
 * @property {boolean} belowTolerance
...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  async onInitializeMediaSourceEngine_(has, wants) {
    ...
    const mediaSourceEngine = this.createMediaSourceEngine(
        ...
        (mediaSegment) => {
          return this.drmEngine_.parseInbandPssh(mediaSegment);
        });
 ...
 * @export
 */
shaka.Player.version = 'v3.1.2-charter21-uncompiled';
