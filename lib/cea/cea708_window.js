...
shaka.cea.Cea708Window = class {
  ...
  forceEmit(endTime, serviceNumber) {
    ...
    if (this.justification_ === TextJustification.LEFT) {
      // LEFT justified.
      caption.cue.textAlign = shaka.text.Cue.textAlign.LEFT;
      caption.cue.firstNonEmptyCol = 0;
    } else if (this.justification_ === TextJustification.RIGHT) {
      // RIGHT justified.
      caption.cue.textAlign = shaka.text.Cue.textAlign.RIGHT;
      caption.cue.firstNonEmptyCol = 0;
    } else {
      // CENTER justified. Set to LEFT to let CEA608 TO commands control indents
      caption.cue.textAlign = shaka.text.Cue.textAlign.LEFT;
    }
    return caption;
  }
