...
shaka.util.PeriodCombiner = class {
  ...
  static isVideoStreamBetterMatch_(outputStream, best, candidate) {
    ...
    // Match on bitrate first to avoid misalignment of bitrates which
    // can prevent use of the highest bitrate stream.
    if (outputStream.bandwidth && best.bandwidth && candidate.bandwidth) {
