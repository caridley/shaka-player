...
shaka.media.TimestampOffsetCorrector = class {
  ...
  constructor() {
    ...
    /**
     * Maps a contentType, e.g., 'audio', 'video', or 'text' to 
     * to data needed to correct timestampOffset
     * 
   ...
   * @returns shaka.media.TimestampOffsetCorrector.mediaData_
   * @private
   */
   ...
   * @return {boolean} true if the timestampOffset has not already been corrected
   *   and we detect a discrepancy in the timestampOffset
   */
  ...
  parseBaseMediaDecodeTime_(mediaData, segmentData) {
    ...
    shaka.log.debug('parseBaseMediaDecodeTime_()',
        'trackId', trackId,
        'timescale', timescale,
  ...
  parseTimescalesFromInitSegment(contentType, initSegment) {
    ...
    shaka.log.debug('parseTimescalesFromInitSegment() ',
        'contentType', contentType,
 ...
 *
 * @property {number|null} timestampOffset
 ...
 * @property {number|null} originalTimestampOffset
